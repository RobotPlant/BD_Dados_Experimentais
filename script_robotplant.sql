...
-- -----------------------------------------------------
-- Table `RP_bd`.`tb_planta_Temperatura`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `RP_bd`.`tb_planta_Temperatura` (
  `tb_temperatura_id_temperatura` INT NOT NULL,
  `tb_Planta_id_Planta` INT NOT NULL,
  PRIMARY KEY (`tb_temperatura_id_temperatura`, `tb_Planta_id_Planta`),
  INDEX `fk_tb_temperatura_has_tb_Planta_tb_Planta1_idx` (`tb_Planta_id_Planta` ASC),
  INDEX `fk_tb_temperatura_has_tb_Planta_tb_temperatura1_idx` (`tb_temperatura_id_temperatura` ASC),
...
-- -----------------------------------------------------
-- Table `RP_bd`.`tb_planta_umidadeSolo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `RP_bd`.`tb_planta_umidadeSolo` (
  `tb_umidade_solo_id_umidade_solo` INT NOT NULL,
  `tb_Planta_id_Planta` INT NOT NULL,
  PRIMARY KEY (`tb_umidade_solo_id_umidade_solo`, `tb_Planta_id_Planta`),
  INDEX `fk_tb_umidade_solo_has_tb_Planta_tb_Planta1_idx` (`tb_Planta_id_Planta` ASC),
  INDEX `fk_tb_umidade_solo_has_tb_Planta_tb_umidade_solo1_idx` (`tb_umidade_solo_id_umidade_solo` ASC),
...
-- -----------------------------------------------------
-- Table `RP_bd`.`tb_planta_umidadeAr`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `RP_bd`.`tb_planta_umidadeAr` (
  `tb_umidade_ar_id_umidade_ar` INT NOT NULL,
  `tb_Planta_id_Planta` INT NOT NULL,
  PRIMARY KEY (`tb_umidade_ar_id_umidade_ar`, `tb_Planta_id_Planta`),
  INDEX `fk_tb_umidade_ar_has_tb_Planta_tb_Planta1_idx` (`tb_Planta_id_Planta` ASC),
  INDEX `fk_tb_umidade_ar_has_tb_Planta_tb_umidade_ar1_idx` (`tb_umidade_ar_id_umidade_ar` ASC),
